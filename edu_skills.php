                                ...
                                <div class="col-md-12">
                                    ...
                                    ?>
                                        <form action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                <input type="submit" style="background-color: #26ae61;border-color: #26ae61;" name="add_edu" class="site-button">
                                            </div>
                                        </form>
                                        <?php
                                    } else {
                        ...
                        <div class="col-md-12">
                            ...
                            ?>
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" style="background-color: #26ae61;border-color: #26ae61;" name="add_skills" class="site-button">
                                    </div>
                                </form>
                                <?php
                            } else {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" style="background-color: #26ae61;border-color: #26ae61;" name="add_exp" class="site-button" value="Add">
                                    </div>
                                </form>
                            </div>
