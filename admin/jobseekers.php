                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table v-middle">
                        ...
                        <tbody>
                            <?php
                            $k = 1;
                            $fetch_data = mysqli_query($connection, "SELECT * FROM jobseekers");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if($row['status'] == "active") {
                                            ?>
                                            <a href='jobseekers.php?draft=<?php echo $row['js_id']; ?>'>Draft</a>
                                            <?php
                                        } else {
                                            ?>
                                            <a href='jobseekers.php?active=<?php echo $row['js_id']; ?>'>Active</a>
                                            <?php
                                        }
                                        ?>
                        ...
                        <?php
                            ...
                            if (isset($_GET['active'])) {
                                ...
                                $active = mysqli_query($connection, "UPDATE jobseekers SET status = 'active' WHERE js_id = '$js_id'");
                            ...
                            if (isset($_GET['draft'])) {
                                ...
                                $draft = mysqli_query($connection, "UPDATE jobseekers SET status = 'draft' WHERE js_id = '$js_id'");
                            ...
                            if (isset($_GET['delete'])) {
                                ...
                                $delete = mysqli_query($connection, "DELETE FROM jobseekers WHERE js_id = '$js_id'");
