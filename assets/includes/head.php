...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,700&amp;display=swap"
        rel="stylesheet">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="assets/cdnjs.cloudflare.com/all.min.css">
    ...
    <!-- Site Main Stylesheet-->
    <link media="all" rel="stylesheet" href="assets/css/jobplugin.css">
    <!-- Site Theme Colors Stylesheet-->
    <link media="all" rel="stylesheet" href="assets/css/theme-color.css">
</head>